document.getElementById('signatureForm').addEventListener('submit', function(event) {
  ...
  // Monta dinamicamente a célula da filial apenas se houver valor
  var filialCell = '';
  if (operation && operationalOfficeInfo) {
      filialCell = '<td style="max-width: 240px; vertical-align: top; text-align: left;"><strong>FILIAL: </strong>' + operationalOfficeInfo + '</td>';
  } else {
      filialCell = '<td style="max-width: 240px; vertical-align: top; text-align: left;"></td>';
  }
...
// Validar o campo corporatePhoneDDD para aceitar apenas 2 caracteres numéricos
